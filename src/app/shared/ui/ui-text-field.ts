  ...
  template: `
    <label class="block">
      ...
      <input [type]="type()" [placeholder]="placeholder()" [value]="value()"
        ...
        class="h-12 w-full rounded-field border border-border bg-surface px-3 text-[15px] text-content outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/30" />
